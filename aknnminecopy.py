...
def aknn(nbrs_arr, labels, thresholds, distinct_labels=['n0', 'n1', 'n2', 'n3', 'n4', 'n5', 'n6', 'n7', 'n8', 'n9']):
    """
    ...
    pred_label = '?' if first_admissible_ndx == len(nbrs_arr) else distinct_labels[np.argmax(biases[:,
                                                                                             first_admissible_ndx])]  # Break any ties between labels at stopping radius, by taking the most biased label
    return (pred_label, first_admissible_ndx, fracs_labels)


def predict_nn_rule(nbr_list_sorted, labels, log_complexity=1.0,
                    distinct_labels=['n0', 'n1', 'n2', 'n3', 'n4', 'n5', 'n6', 'n7', 'n8', 'n9']):
    """
